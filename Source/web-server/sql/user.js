module.exports = {
    ...
    selectProjectBuild : "select * from was_ide.history_build where project_id = ? ",
    ...
    deleteProject: "delete from was_ide.project where id = ?",
    deleteHistoryProject: "delete from was_ide.history_build where project_id = ?"
}